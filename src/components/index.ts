...
export { TheNumberPercentage } from "./percent.calculator/TheNumberPercentage";
export { TheNumberPercentageOfTheNumber } from "./percent.calculator/TheNumberPercentageOfTheNumber";